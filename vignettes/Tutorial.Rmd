...
```{r, echo=FALSE}
path = "/gpfs/gibbs/pi/zhao/xs282/validation/revision/"
```
...
```{r}
count_data = readMM(paste0(path,"smart_seq_data/counts.read.txt"))
cells = read.table(paste0(path,"smart_seq_data/cells.read.new.txt"))
genes = read.table(paste0(path,"smart_seq_data/genes.read.txt"))
meta = read.table(paste0(path,"smart_seq_data/meta.txt"), sep = "\t", header=T)
